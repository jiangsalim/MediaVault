    ...
    <Layout>
      <section className="py-8">
        <div className="container-site max-w-3xl mx-auto">
          ...
          {query && (
            <>
              <h1 className="text-xl font-bold text-navy dark:text-white mb-6">
                Results for "{query}"
              </h1>
              ...
              {loading ? (
                ...
                <p className="text-center text-charcoal dark:text-gray-light py-10">No results found. Try a different search term.</p>
              ) : (
                <div className="card-base divide-y divide-gray-light dark:divide-navy-light overflow-hidden">
                  {results.map((song: any) => (
                    <a
                      ...
                      className="flex items-center gap-3 p-3 transition-colors hover:bg-gray-light dark:hover:bg-navy-light overflow-hidden"
                    >
