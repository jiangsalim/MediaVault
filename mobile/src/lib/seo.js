...
export function getSiteSchema() {
  return {
    ...
    '@type': 'WebSite',
    name: 'MediaVault',
    url: 'https://mediavault.vercel.app',
    description: 'Free music downloads - MP3 songs from Uganda and East Africa',
  };
}

export function getSongSchema(song) {
  return {
    '@context': 'https://schema.org',
    '@type': 'MusicRecording',
    name: song.title,
    byArtist: { '@type': 'MusicGroup', name: song.artist },
    duration: song.duration || 'PT3M35S',
